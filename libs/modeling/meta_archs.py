        ...
        for i, (cls_i, offsets_i, ref_i, prob_i, pts_i, mask_i) in enumerate(zip(
            ...
            if True:
                ...
                for j in range(i+1):  # 1 2 3 4 5 6
                    # 1 2 4 8 16 32
                    ref = out_refines[(i)-j].squeeze(1)
                    prob = out_probs[(i)-j].squeeze(1)
                    ...
                    seg_left[left_mask] += (ref_left*stride_i/8) * prob_left
                    ...
                    seg_right[right_mask] += (ref_right*stride_i/8) * prob_right
                    stride_i //= 2
